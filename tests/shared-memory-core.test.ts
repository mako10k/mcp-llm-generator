import { SharedMemoryCore, CreateMemoryRequest } from '../src/core/shared-memory-core.js';
import Database from 'better-sqlite3';

describe('SharedMemoryCore', () => {
  let db: Database.Database;
  let core: SharedMemoryCore;
  ...
  describe('searchMemories', () => {
    ...
    test('キーワード検索', () => {
      ...
      const result = core.searchMemories(
        { query: 'JavaScript', limit: 10, offset: 0 }, 
        'persona-123'
      );
