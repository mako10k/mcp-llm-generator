 ...
 */
import { DEFAULT_PERSONALITY_PRESETS, DEFAULT_VALUES } from '../types/index.js';
// =============================================================================
 ...
 */
export function calculateConversationTokens(conversations) {
 ...
 */
export function truncateConversationHistory(conversations, maxTokens) {
    ...
    const includedMessages = [...systemMessages];
    ...
    const result = includedMessages.sort((a, b) => new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime());
 ...
 */
export function createContextFromPreset(presetId, name, overrides, database // Optional database instance for dynamic preset lookup
) {
    // First, try to find in static presets
    const staticPreset = DEFAULT_PERSONALITY_PRESETS[presetId];
    if (staticPreset) {
 ...
 */
export function createConversation(contextId, role, content) {
    return {
 ...
 */
export function updatePersonalityPreset(preset, updates) {
 ...
 */
export function filterContexts(contexts, criteria = {}) {
 ...
 */
export function filterPresets(presets, criteria = {}) {
