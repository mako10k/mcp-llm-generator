...
import { 
  SharedMemoryToolsManager,
  createSharedMemoryTool,
  searchSharedMemoryTool,
  getSharedMemoryTool,
  updateSharedMemoryTool,
  deleteSharedMemoryTool,
  getSharedMemoryNotificationsTool
 ...
 */
export function registerSharedMemoryTools(server: any, database: Database.Database) {
