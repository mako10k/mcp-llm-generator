...
${descriptions}`;
     ...
     */
    formatParameters(parameters, requiredParams, optionalParams) {
...
\`\`\``;
     ...
     */
    generatePersonaSection(persona) {
...
Please analyze this request and determine if any tools should be called. Respond with the exact JSON format specified.`;
     ...
     * スキーマ複雑度の計算
     */
    calculateSchemaComplexity(tools) {
